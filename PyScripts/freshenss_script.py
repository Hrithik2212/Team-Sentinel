...
def process_image(image_url, threshold=0.7):
    ...
    predicted_label, probability = classify_image(image, model, device, threshold=threshold)
    ...
    result = {
        ...
        "state": predicted_label,  # Model prediction ('fresh' or 'rotten')
        "threshold": probability   # Model probability
    }
